...
console.log(config.kvSigningKeyId, config.kvRemoteSigningKeyId)
...
const credential = 'https://beta.did.msidentity.com/v1.0/fd6f2583-bfcc-4b13-9401-f1786c716098/verifiableCredential/contracts/modifiedCredentialExpert';
const credentialType = ['MyFirstVC'];
